...
object DummyData {
    ...
    val burgerHubMenu = listOf(
        CreateMenuItemResponse(
            id = "m20",
            name = "Classic isVeg Burger",
            description = "Crispy isVeg patty with lettuce, tomato, and mayo",
            price = 89.0,
            category = "Burgers",
            isVeg = true,
            available = true,
    ...
    val momosJunctionMenu = listOf(
        CreateMenuItemResponse(
            id = "m40",
            name = "isVeg Steamed Momos (8 pcs)",
            description = "Steamed isVegetable momos with spicy chutney",
            price = 79.0,
            category = "Momos",
            isVeg = true,
            available = true,
        ...
        CreateMenuItemResponse(
            id = "m43",
            name = "isVeg Hakka Noodles",
            description = "Stir-fried noodles with isVegetables",
            price = 89.0,
            category = "Noodles",
            isVeg = true,
            available = true,
        ...
        CreateMenuItemResponse(
            id = "m45",
            name = "isVeg Manchurian",
            description = "isVegetable balls in spicy Manchurian sauce",
            price = 99.0,
            category = "Manchurian",
            isVeg = true,
            available = true,
...
val dummyActiveOrders = listOf(
    ...
    GetOrderByIdResponse(
        ...
        orderItems = listOf(
            OrderItemX(menuItemName = "isVeggie Wrap", quantity = 1),
...
val dummyCompletedOrders = listOf(
    ...
    GetOrderByIdResponse(
        ...
        orderItems = listOf(
            OrderItemX(menuItemName = "Bean and isVeggie Burger", quantity = 1),
